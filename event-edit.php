...
<a href="Delete.php?id=<?php echo $id; ?>"><button type="button" class="eventbtn btn-danger col-auto rounded-0 " style="margin-left: 60px;">Delete event</button></a>


<a href="update.php?id=<?php echo $id; ?>"><button type="button" class="eventbtn btn-success col-auto rounded-0 ">Edit event</button></a>




    <a href="event-organizer.php" class="more-events">More events...</a>
  </div>
</div>
